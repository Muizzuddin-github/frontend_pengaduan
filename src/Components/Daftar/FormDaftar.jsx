const FormDaftar = () => {
    return (
        <form className="space-y-4 md:space-y-6" action="#">
            <div>
                <label htmlFor="username" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username Anda</label>
            ...
            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                Sudah Punya Akun? <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Login</a>
            </p>
        </form>
    );
}
